...
export const SectionContact = () => {
    return (
        <section className="w-full px-10 mt-[100px] ">
        <h2 className="mb-10 text-[24px] font-bold text-center text-gray-600">聯絡我們 / 查詢報價</h2>
        <div className="space-y-5 mx-auto max-w-max">
